...
const Footer = () => {
  ...
  <div class="container px-5 mx-auto">
    <div class="flex flex-wrap md:text-left text-center order-first">
      <div class="lg:w-1/4 md:w-1/2 sm:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          ...
          <li>
            <a class="text-gray-600 hover:text-gray-800">Gadgets</a>
          </li>
          <li>
            <a class="text-gray-600 hover:text-gray-800">Computers</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/4 md:w-1/2 sm:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          ...
          <li>
            <a class="text-gray-600 hover:text-gray-800">Custom Designs</a>
          </li>
          <li>
      ...
      <div class="lg:w-1/4 md:w-1/2 sm:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <a class="text-gray-600 hover:text-gray-800">Address</a>
          </li>
          <li>
      ...
      <div class="lg:w-1/4 md:w-1/2 sm:w-1/2 w-full px-4">
        ...
        <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          ...
          <button class="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded sm:mt-2">Send</button>
        </div>
        <p class="text-gray-500 text-sm mt-2 md:text-left text-center">Commment tour feedbacks
        </p>
      </div>
    </div>
  </div>
  <div class="bg-gray-100">
    <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        ...
        <span class="ml-3 text-xl">Fashion Store</span>
      </a>
      <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2023 Fashion Store —
        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">@fashionstore</a>
      </p>
